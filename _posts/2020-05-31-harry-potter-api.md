...
image: ../assets/images/witchcraft.webp
image_attribution: Header image by <a href="https://unsplash.com/@art_maltsev">Artem Maltsev</a> on <a href="https://unsplash.com">Unsplash</a>
excerpt: This post explains what an API is and how to connect to one using Python, aiming to give an accessible introduction to a topic that can be bewildering to explore.
---
